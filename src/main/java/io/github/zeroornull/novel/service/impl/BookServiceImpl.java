...
import io.github.zeroornull.novel.dao.mapper.*;
...
import io.github.zeroornull.novel.manager.cache.*;
...
public class BookServiceImpl implements BookService {
    ...
    public RestResp<PageRespDto<BookInfoRespDto>> listAuthorBooks(PageReqDto dto) {
        ...
        return RestResp.ok(PageRespDto.of(dto.getPageNum(), dto.getPageSize(), page.getTotal(), bookInfoIPage.getRecords().stream().map(v -> BookInfoRespDto.builder()
                .id(v.getId())
    ...
    public RestResp<Void> deleteBookChapter(Long chapterId) {
        ...
        if (Objects.equals(bookInfo.getLastChapterId(), chapterId)) {
            ...
            bookChapterQueryWrapper.eq(DatabaseConsts.BookChapterTable.COLUMN_BOOK_ID, chapter.getId())
                    .orderByDesc(DatabaseConsts.BookChapterTable.COLUMN_CHAPTER_NUM)
                    .last(DatabaseConsts.SqlEnum.LIMIT_1.getSql());
