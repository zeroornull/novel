...
import io.github.zeroornull.novel.dao.mapper.HomeBookMapper;
 ...
 *
 * @author pax
 * @since 2024-10-12 02:57:54
 */
@Component
@RequiredArgsConstructor
public class HomeBookCacheManager {
    private final HomeBookMapper homeBookCache;
    ...
    public List<HomeBookRespDto> listHomeBooks() {
        ...
        List<HomeBook> homeBooks = homeBookCache.selectList(queryWrapper);
        ...
        if (!CollectionUtils.isEmpty(homeBooks)) {
            ...
            if (!CollectionUtils.isEmpty(bookInfos)) {
                //Function.identity()：返回一个函数，该函数对输入的对象不做任何变换，直接返回自身。
