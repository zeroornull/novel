...
import io.github.zeroornull.novel.core.config.MailProperties;
...
public class RegisterMailSender extends AbstractMailSender{
    ...
    @Override
    protected String resolveTitle(String content, Object[] arguments) {
        // TODO 去数据库/配置文件中查询网站配置
        String websiteLink = "https://www.173114.xyz";
        String websiteEmail = "lonely20240710@gmail.com";

        return super.resolveContent(content,
                Stream.of(arguments, new Object[]{websiteLink, websiteEmail}).flatMap(Arrays::stream).toArray());
    }
